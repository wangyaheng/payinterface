 ...
 * @author jingyuan.ma
 */
public class ProvisionsScheduleBatchBean implements Serializable {
	/**通道编号*/
	...
	/** 付款通道类型 */
	private ScheduleHandlerType handlerType;
	...
	public ScheduleHandlerType getHandlerType() {
		return handlerType;
	}
	public void setHandlerType(ScheduleHandlerType handlerType) {
