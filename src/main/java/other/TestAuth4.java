	...
	try {
		...
		for(int i=0;i<=lastRowNum;i++) {
			...
			//  
			 ...
			 //paramMap.put("partner",  "86101961874");//  卡友生产
			 paramMap.put("partner",  "86191111139");  //  卡友测试
			 //paramMap.put("partner",  "86101162845");  //  卡友测试
			 //paramMap.put("partner",  "8627193115");//  
			 paramMap.put("requestCode",  "RQJHF3"  +  System.currentTimeMillis());
			 paramMap.put("busiType",  "BINDCARD_AUTH");//绑卡认证
			 //paramMap.put("busiType",  "IDENTITY_AUTH");//  身份认证
			...
			// String url = "http://10.10.129.49:8083/auth-front/auth/trade.htm";//卡友测试
			 //String url = "http://116.213.198.30/auth-front/auth/trade.htm";
			  String url = "https://jh.cardinfo.com.cn/auth-front/auth/trade.htm";//卡友生产
			 try {
			 ...
			 //System.out.println(json2Bean);
			  ...
			  FileWriter fw = new FileWriter("C://Users//hasee//Desktop//4.txt", true);
